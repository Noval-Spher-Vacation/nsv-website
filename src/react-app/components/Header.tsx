      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="flex items-center space-x-2">
            <div className="w-10 h-10 bg-gradient-to-br from-pink-600 to-pink-800 rounded-full flex items-center justify-center">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <Link to="/offers" className="text-gray-700 hover:text-pink-600 transition">
              Offers
            </Link>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <Link
              to="/contact"
              className="bg-pink-600 text-white px-6 py-2.5 rounded-full hover:bg-pink-700 transition shadow-lg shadow-pink-600/30"
            >
              Get Quote
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden py-4 border-t">
            <div className="flex flex-col space-y-3">
              <Link to="/" className="text-gray-700 hover:text-pink-600 transition py-2">
                Home
              </Link>
              <Link to="/about" className="text-gray-700 hover:text-pink-600 transition py-2">
                About
              </Link>
              <Link to="/destinations" className="text-gray-700 hover:text-pink-600 transition py-2">
                Destinations
              </Link>
              <Link to="/packages" className="text-gray-700 hover:text-pink-600 transition py-2">
                Tours & Packages
              </Link>
              <Link to="/services" className="text-gray-700 hover:text-pink-600 transition py-2">
                Services
              </Link>
              <Link to="/offers" className="text-gray-700 hover:text-pink-600 transition py-2">
                Offers
              </Link>
              <Link to="/contact" className="text-gray-700 hover:text-pink-600 transition py-2">
                Contact
              </Link>
              <a
                href="tel:8248596124"
                className="text-pink-600 font-semibold py-2 flex items-center space-x-2"
              >
                <Phone className="w-5 h-5" />
